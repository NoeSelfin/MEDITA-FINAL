...
public class SuscripcionBak extends Activity implements IabHelper.OnIabSetupFinishedListener, IabHelper.OnIabPurchaseFinishedListener{
...
//        prefs = getSharedPreferences("Preferencias", Context.CONTEXT_INCLUDE_CODE | Context.CONTEXT_IGNORE_SECURITY);
        ...
        tvCerrarSesion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(SuscripcionBak.this, MainActivity.class);
                startActivity(i);
                finish();
        ...
        billingHelper = new IabHelper(SuscripcionBak.this, Config.license_key);
...
//                adapter.notifyDataSetChanged();
    ...
    private void saveSubscription(Purchase p) throws JSONException {
        ...
        new Downloader.SaveSuscription(Basics.checkConn(SuscripcionBak.this),
                ...
                Basics.getCancelDate(SuscripcionBak.this, p.getSku(), p.getPurchaseTime()),
    ...
    public void setMenu(){
        menu_lateral = new SlidingMenu(SuscripcionBak.this);
        ...
        contacto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(SuscripcionBak.this, LogIn.class);
                startActivity(i);
                finish();
            }
        });
        ...
        news.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(SuscripcionBak.this, Novedades.class);
                startActivity(i);
                finish();
            }
        });
        ...
        acercade.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(SuscripcionBak.this, Acercade.class);
                startActivity(i);
                finish();
            }
        });
        ...
        opciones.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(SuscripcionBak.this, Opciones.class);
                startActivity(i);
                finish();
            }
        });
        ...
        vision.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(SuscripcionBak.this, Vision.class);
        ...
        favoritos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(SuscripcionBak.this, Favoritos.class);
                startActivity(i);
                finish();
            }
        });
        ...
        inicio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if(functions.shouldShowMenu()){
                    Intent i = new Intent(SuscripcionBak.this, Home.class);
                    startActivity(i);
                    finish();
                }else{
                    Intent i = new Intent(SuscripcionBak.this, MainActivity.class);
        ...
        progreso.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(SuscripcionBak.this, Charts.class);
                startActivity(i);
                finish();
            }
        });
    ...
    protected void errorAlIniciar() {
        Toast.makeText(SuscripcionBak.this, "Error al intentar iniciar la compra", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void alertOk(String mensaje){
        ...
        final Dialog dialog = new Dialog(SuscripcionBak.this);
    ...
    protected void alertSuscripcion(){
        ...
        ver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(check.isChecked()){
                    if (Basics.checkConn(SuscripcionBak.this)){
                    ...
                    Toast.makeText(SuscripcionBak.this, "Ha de aceptar la pol?tica de privacidad", Toast.LENGTH_SHORT).show();
                }
    ...
    private class setRegistro extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            String mac = Basics.getWifiMac(SuscripcionBak.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result != null){
                if ((result.trim().compareTo("4") == 0)||(result.trim().compareTo("0") == 0)){
                    ...
                    Intent i = new Intent(SuscripcionBak.this, Sincro2.class);
                    i.addFlags(Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT);
                    startActivity(i);
                    finish();
                }
    ...
    private class getPromo extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (code){
                ...
                Toast.makeText(SuscripcionBak.this,"Código erróneo",Toast.LENGTH_LONG).show();
