...
public class Config {
	...
	public final static String bearer = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHAiOiJNZWRpdGEiLCJuYW1lIjoiYW5vbnltb3VzIn0.UkmfFFYEeyfr3Zq1-QyH7nXHkvqod8M6iXlBhqLphIw";
	public final static String tag = "medita_compras";
    protected final static String plataforma = "android";
...
//	protected final static String license_key = "";
	protected final static String url_base = "https://app.atentamente.net";
	//protected final static String url_iconos = "http://medita.atentamente.net/iconos/";
	protected final static String url_iconos = "https://appmeditapro.s3.eu-west-1.amazonaws.com/iconos/";
	//protected final static String url_fondos = "http://medita.atentamente.net/fondos/";
	protected final static String url_fondos = "https://appmeditapro.s3.eu-west-1.amazonaws.com/fondos/";
	//protected final static String url_meditaciones = "http://medita.atentamente.net/meditaciones/";
	protected final static String url_meditaciones = "https://appmeditapro.s3.eu-west-1.amazonaws.com/meditaciones/";
	//protected final static String url_get_packs = "http://medita.atentamente.net/get_packs.php";
	protected final static String url_get_packs = "https://app.atentamente.net/api/getPacks";
	//protected final static String url_get_meditaciones  = "http://medita.atentamente.net/get_meditaciones.php";
	protected final static String url_get_meditaciones  = "https://app.atentamente.net/api/getMeditations";
...
//	protected final static String url_nota_legal = "https://www.atentamente.net/aviso-legal/";
	...
	protected final static String url_get_promo  = "https://app.atentamente.net/api/getPromo";
	...
	public static String sharedprefDateFormat = "yyyy-MM-dd";
