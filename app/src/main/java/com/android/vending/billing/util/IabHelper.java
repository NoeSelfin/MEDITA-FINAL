...
//                Log.d ("myApplication", key + " is a key in the bundle");
                logDebug("test bundle ownedItems: " + key);
            }
            ...
            if(ownedSkus.size() > 0){
                for (int i = 0; i < ownedSkus.size(); i++) {
                    logDebug("purchaseDataList " + i + " info: " + ownedSkus.get(i));
                }
            }
            ...
            if(purchaseDataList.size() > 0){
                for (int i = 0; i < purchaseDataList.size(); i++) {
                    logDebug("purchaseDataList " + i + " info: " + purchaseDataList.get(i));
                }
            }
            ...
            if(signatureList.size() > 0){
                for (int i = 0; i < signatureList.size(); i++) {
                    logDebug("signatureList " + i + " info: " + signatureList.get(i));
                }
            }
            for (int i = 0; i < purchaseDataList.size(); ++i) {
